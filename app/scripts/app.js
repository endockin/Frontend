				...
				login : function(){
					console.log($scope.formData.username, $scope.formData.password)
						...
						method: 'POST',
						  ...
						  data: { "id": $scope.formData.username,"password" : $scope.formData.password}, 
						...
						crossDomain : true,
							...
							$scope.login.token= serverData.key ;
							$scope.login.generatedAt=serverData.generatedAt;
							$scope.login.validUntil=serverData.validUntil;
							$state.go('user')
